...
YOLOP = [
    ...
    [[17, 20, 23], Detect,
     [1, [[3, 9, 5, 11, 4, 20], [7, 18, 6, 39, 12, 31], [19, 50, 38, 81, 68, 157]], [128, 256, 512]]],  # 检测头
    # Detection head 24
...
YOLOP_lane_robot = [
    ...
    # cls_dim=(37, 10, 4) 和 target_spatial_size=(9, 25) 参照原始parsingNet的默认值
    [9, LaneParsingHead, [512, (101, 56, 2), (9, 25)]]  # 43: Lane pasrsing head
]
...
if __name__ == "__main__":
    ...
    input_ = torch.randn((1, 3, 320, 320))

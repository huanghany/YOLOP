...
_C.DATASET.DATAROOT = '/home/huayi/hhy/YOLOP/Datasets/datasets/images/'       # the path of images folder
_C.DATASET.LABELROOT = '/home/huayi/hhy/YOLOP/Datasets/datasets/det_annotations'      # the path of det_annotations folder
_C.DATASET.MASKROOT = '/home/huayi/hhy/YOLOP/Datasets/datasets/da_seg_annotations'                # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = '/home/huayi/hhy/YOLOP/Datasets/datasets/ll_seg_annotations'               # the path of ll_seg_annotations folder
_C.DATASET.DATASET = 'BddDataset'
_C.DATASET.TRAIN_SET = 'train'
_C.DATASET.TEST_SET = 'val'
_C.DATASET.DATA_FORMAT = 'jpg'
_C.DATASET.SELECT_DATA = False  # 筛选数据
_C.DATASET.ORG_IMG_SIZE = [720, 1280]  # 原始图片长宽 640 640

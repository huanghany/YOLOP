...
model = torch.load('/home/huayi/hhy/YOLOP/runs/RobotViewDataset/checkpoint.pth')
# model = torch.load('/home/huayi/hhy/YOLOP/runs/RobotViewDataset/model_0526.pth')

# print(model)
model_weights = model['state_dict']

torch.save(model_weights, "/home/huayi/hhy/YOLOP/runs/RobotViewDataset/model_0527.pth")

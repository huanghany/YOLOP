...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='inference/huayi_1', help='source')  # file/folder   ex:inference/images
    ...
    parser.add_argument('--save-dir', type=str, default='inference/hy_result_3', help='directory to save results')
